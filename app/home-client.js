...
export default function HomePage() {
  ...
  return (
    <main className="relative mx-auto min-h-screen w-[min(1200px,92vw)] py-6 md:py-10">
      ...
      <header className="flex items-center justify-between gap-4">
        <a href="/" aria-label="GrayGlyph Home" className="inline-flex items-center">
          <NextImage
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-[#f5b700] px-3 py-2 text-sm font-semibold text-[#1b1f27] transition hover:brightness-95"
        >
          Star on GitHub
        </a>
      </header>
      ...
      <section className="mt-5 grid gap-4 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
        <div className="glass-panel animate-rise p-6 md:p-7">
          <h1 className="font-serifDisplay text-3xl leading-tight text-ink md:text-5xl">
            Free Online Image Tools - Grayscale, Photo Editing & Color Grading
          </h1>
          <p className="mt-3 text-sm leading-relaxed text-ink-soft md:text-base">
            All GrayGlyph tools run fully in your browser with no uploads. Enjoy privacy-first editing for image to grayscale conversion, online photo editor workflows, and color grade transfer without sending files to a server.
          </p>
        </div>
        <div className="glass-soft-panel animate-rise p-5 md:p-6" style={{ animationDelay: "80ms" }}>
          <p className="text-sm font-semibold uppercase tracking-wide text-ink-soft">Why GrayGlyph</p>
          <ul className="mt-3 space-y-2 text-sm text-muted">
            <li>Zero uploads or accounts required</li>
            <li>Fast, private, browser photo editor workflows</li>
            <li>Accurate previews with non-destructive processing</li>
      ...
      <section className="mt-6 grid gap-4 lg:grid-cols-3">
        <a
          href="/#grayscale-tool"
          className="glass-panel animate-rise block h-full p-5 transition hover:shadow-[0_18px_48px_rgba(18,21,28,0.2)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
        >
          <div className="flex h-full flex-col">
          <div className="flex items-center gap-3">
            <span className="grid h-10 w-10 place-items-center rounded-full bg-[rgba(213,108,79,0.18)] text-ink">
              <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden="true">
                <path d="M12 4a8 8 0 108 8 8 8 0 00-8-8zm0 2v12a6 6 0 110-12z" />
              </svg>
            </span>
            <h2 className="text-xl font-semibold">Image to Grayscale & Black and White</h2>
          </div>
          <p className="mt-3 text-sm text-ink-soft">
            Convert images to high-quality grayscale or black and white instantly. This image to grayscale and black and white converter delivers a true grayscale image online experience without uploads.
          </p>
          <ul className="mt-3 list-disc space-y-1 pl-5 text-sm text-ink-soft">
            <li>Luminance-accurate grayscale conversion</li>
            <li>Real-time preview & comparison</li>
            <li>Non-destructive processing</li>
            <li>Works offline after load</li>
          </ul>
          <span className="btn-primary mt-auto inline-flex pointer-events-none">Convert Image</span>
          </div>
        </a>
        ...
        >
          <div className="flex h-full flex-col">
          <div className="flex items-center gap-3">
            <span className="grid h-10 w-10 place-items-center rounded-full bg-[rgba(60,125,108,0.18)] text-ink">
              <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden="true">
                <path d="M4 6h16v2H4zm0 5h16v2H4zm0 5h16v2H4z" />
              </svg>
            </span>
            <h2 className="text-xl font-semibold">Free Online Photo Editor</h2>
          </div>
          <p className="mt-3 text-sm text-ink-soft">
            Edit photos directly in your browser with professional controls. This online photo editor and browser photo editor lets you edit images online with full privacy.
          </p>
          <ul className="mt-3 list-disc space-y-1 pl-5 text-sm text-ink-soft">
            <li>Exposure, contrast, highlights & shadows</li>
            <li>Crop, rotate, flip & straighten</li>
            <li>Before / After comparison</li>
            <li>Non-destructive editing</li>
          </ul>
          <span className="btn-primary mt-auto inline-flex pointer-events-none">Open Editor</span>
          </div>
        </a>
        ...
        >
          <div className="flex h-full flex-col">
          <div className="flex items-center gap-3">
            <span className="grid h-10 w-10 place-items-center rounded-full bg-[rgba(38,57,79,0.18)] text-ink">
              <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden="true">
                <path d="M4 17h16v2H4zm0-5h16v2H4zm0-5h16v2H4z" />
              </svg>
            </span>
            <h2 className="text-xl font-semibold">Color Grade Transfer</h2>
          </div>
          <p className="mt-3 text-sm text-ink-soft">
            Apply the color mood of one image to another with color grade transfer. Get image color matching and color grading online without presets or uploads.
          </p>
          <ul className="mt-3 list-disc space-y-1 pl-5 text-sm text-ink-soft">
            <li>Source to target color matching</li>
            <li>Intensity-controlled transfer</li>
            <li>High-fidelity color preservation</li>
            <li>Client-side processing only</li>
          </ul>
          <span className="btn-primary mt-auto inline-flex pointer-events-none">Transfer Color Grade</span>
          </div>
        </a>
      </section>
      ...
      <section className="glass-panel mt-6 p-5">
        ...
        <p className="mt-2 text-sm text-ink-soft">
          GrayGlyph is built for privacy-first image editing with no uploads or accounts.
        </p>
      ...
      <section
        id="grayscale-tool"
        className="mt-6 grid gap-4 lg:grid-cols-[360px_minmax(0,1fr)] lg:items-start"
        ...
        <div className="order-2 space-y-4 lg:order-1">
          <section className="glass-panel animate-rise p-5">
            ...
            <div className="mt-3 flex flex-wrap gap-2.5">
              ...
              <button type="button" onClick={handleDownload} disabled={!hasImage} className="btn-ghost disabled:cursor-not-allowed disabled:opacity-50">
                Download Image
              </button>
            </div>
          </section>
